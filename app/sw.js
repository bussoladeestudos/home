/* ════════════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════════════ */
const CACHE = "bussola-v136";   // v136 (19/09): cpror-cli-01 reescrito em tom didatico; conteudo-cpror em ?v=20260919-cli01r2. Preserva filtro, resumo do banco e questoes de v133 a v135.
const SHELL = [
  "./",
  "index.html",
